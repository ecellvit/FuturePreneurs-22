  ...
  useEffect(() => {
    fetch(`${process.env.NEXT_PUBLIC_SERVER3}/api/team`, {
      ...
      headers: {
        ...
        Authorization: `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2MzFhMWE1MGViOWVlNjVjYmRlYjU1NWEiLCJpYXQiOjE2NjI4MTc4NTQsImV4cCI6MTY2MzI0OTg1NH0.vFtFIMUXMcfLsNITO6QOtKOLqZ0O4aJTCbNeapDJofo`,
